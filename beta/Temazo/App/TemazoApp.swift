        ...
        WindowGroup {
            MainScreen()
                ...
                .task {
                    ...
                    // de no-favorito a favorito. DownloadManager decide si descarga
                    // (respeta el toggle wifiOnly del user).
                    FavoritesRepo.shared.onFavoriteAdded = { track in
                        Task { @MainActor in
                            // BETA v1.2.17: silencioso — sin toast por cada corazón.
                            // Los badges de Ajustes ya reflejan estado en tiempo real.
                            guard SettingsRepo.shared.autoDownloadFavorites else { return }
