...
/// Player iOS basado en WKWebView + YouTube IFrame API.
///
/// Misma arquitectura que el Android Player.kt (que va finísimo):
///  - Pre-warm de la página HTML al arrancar la app (chromium engine listo)
...
///
/// API pública idéntica a la versión anterior (AVPlayer) → el resto de la app
/// (MiniPlayer, FullPlayer, MainScreen) no necesita cambios.
@MainActor
